				...
				<div class="row">
					<div class="col-md-4 col-sm-6">
						<div class="blog-post">
							...
							<div class="down-content">
								<a href="<?= base_url('Cosmic_Game_Shop/dataDetails_parentParent_Consoles') ?>">
									...
									<div class="row">
										<div class="col-lg-12">
											<ul class="post-tags">
												...
												<li><a href="<?= base_url('Cosmic_Game_Shop/dataDetails_parentParent_Consoles') ?>">View Products</a></li>
											</ul>
										</div>
									</div>
								</div>
					...
					<div class="col-md-4 col-sm-6">
						<div class="blog-post">
							...
							<div class="down-content">
								<a href="<?= base_url('Cosmic_Game_Shop/dataDetails_parentParent_Accessories') ?>">
								...
								<div class="post-options">
									<div class="row">
										<div class="col-lg-12">
											<ul class="post-tags">
												<li><i class="fa fa-bullseye"></i></li>
												<li><a href="<?= base_url('Cosmic_Game_Shop/dataDetails_parentParent_Accessories') ?>">View Product</a></li>
											</ul>
										</div>
									</div>
								</div>
					...
					<div class="col-md-4 col-sm-6">
						<div class="blog-post">
							...
							<div class="down-content">
								<a href="<?= base_url('Cosmic_Game_Shop/dataDetails_parentParent_Games') ?>">
								...
								<div class="post-options">
									<div class="row">
										<div class="col-lg-12">
											<ul class="post-tags">
												<li><i class="fa fa-bullseye"></i></li>
												<li><a href="<?= base_url('Cosmic_Game_Shop/dataDetails_parentParent_Games') ?>">View Product</a></li>
											</ul>
										</div>
									</div>
								</div>
