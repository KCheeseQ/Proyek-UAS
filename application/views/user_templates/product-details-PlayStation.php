				...
				<div class="row">
					<div class="col-md-4 col-sm-6">
						<div class="blog-post">
							...
							<div class="down-content">
								<a href="<?= base_url('Cosmic_Game_Shop/dataDetails_Parent_ConsolesParent') ?>">
									...
									<div class="row">
										<div class="col-lg-12">
											<ul class="post-tags">
												...
												<li><a href="<?= base_url('Cosmic_Game_Shop/dataDetails_Parent_ConsolesParent') ?>">View Products</a></li>
											</ul>
										</div>
									</div>
								</div>
					...
					<div class="col-md-4 col-sm-6">
						<div class="blog-post">
							...
							<div class="down-content">
								<a href="<?= base_url('Cosmic_Game_Shop/dataDetails_Parent_AccessoriesParent') ?>">
								...
								<div class="post-options">
									<div class="row">
										<div class="col-lg-12">
											<ul class="post-tags">
												<li><i class="fa fa-bullseye"></i></li>
												<li><a href="<?= base_url('Cosmic_Game_Shop/dataDetails_Parent_AccessoriesParent') ?>">View Product</a></li>
											</ul>
										</div>
									</div>
								</div>
					...
					<div class="col-md-4 col-sm-6">
						<div class="blog-post">
							...
							<div class="down-content">
								<a href="<?= base_url('Cosmic_Game_Shop/dataDetails_Parent_GamesParent') ?>">
								...
								<div class="post-options">
									<div class="row">
										<div class="col-lg-12">
											<ul class="post-tags">
												<li><i class="fa fa-bullseye"></i></li>
												<li><a href="<?= base_url('Cosmic_Game_Shop/dataDetails_Parent_GamesParent') ?>">View Product</a></li>
											</ul>
										</div>
									</div>
								</div>
