				...
				<div class="row">
					<div class="col-md-4 col-sm-6">
						<div class="blog-post">
							...
							<div class="down-content">
								<a href="<?= base_url('Cosmic_Game_Shop/dataDetails_Parent') ?>">
									<h4><span>XBOX</span></h4>
								</a>
									...
									<div class="row">
										<div class="col-lg-12">
											<ul class="post-tags">
												...
												<li><a href="<?= base_url('Cosmic_Game_Shop/dataDetails_Parent') ?>">View Products</a></li>
											</ul>
										</div>
									</div>
								</div>
					...
					<div class="col-md-4 col-sm-6">
						<div class="blog-post">
							...
							<div class="down-content">
								<a href="<?= base_url('Cosmic_Game_Shop/dataDetails_Parent_2') ?>">
									<h4><span>PlayStation</span></h4>
								</a>
								<div class="post-options">
									<div class="row">
										<div class="col-lg-12">
											<ul class="post-tags">
												<li><i class="fa fa-bullseye"></i></li>
												<li><a href="<?= base_url('Cosmic_Game_Shop/dataDetails_Parent_2') ?>">View Product</a></li>
											</ul>
										</div>
									</div>
								</div>
					...
					<div class="col-md-4 col-sm-6">
						<div class="blog-post">
							...
							<div class="down-content">
								<a href="<?= base_url('Cosmic_Game_Shop/dataDetails_Parent_3') ?>">
									<h4><span>Nintendo</span></h4>
								</a>
								<div class="post-options">
									<div class="row">
										<div class="col-lg-12">
											<ul class="post-tags">
												<li><i class="fa fa-bullseye"></i></li>
												<li><a href="<?= base_url('Cosmic_Game_Shop/dataDetails_Parent_3') ?>">View Product</a></li>
											</ul>
										</div>
									</div>
								</div>
