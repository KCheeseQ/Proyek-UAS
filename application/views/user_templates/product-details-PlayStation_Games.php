				...
				<div class="row">
					<div class="col-md-4 col-sm-6">
						<div class="blog-post">
							...
							<div class="down-content">
								<a href="<?= base_url('Cosmic_Game_Shop/dataDetails_Parent_GamesParent_Games_PS4') ?>">
									...
									<div class="row">
										<div class="col-lg-12">
											<ul class="post-tags">
												...
												<li><a href="<?= base_url('Cosmic_Game_Shop/dataDetails_Parent_GamesParent_Games_PS4') ?>">View Product</a></li>
											</ul>
										</div>
									</div>
								</div>
					...
					<div class="col-md-4 col-sm-6">
						<div class="blog-post">
							...
							<div class="down-content">
								<a href="<?= base_url('Cosmic_Game_Shop/dataDetails_Parent_GamesParent_Games_PS5') ?>">
