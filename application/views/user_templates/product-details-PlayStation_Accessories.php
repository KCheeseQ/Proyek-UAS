				...
				<div class="row">
					<div class="col-md-4 col-sm-6">
						<div class="blog-post">
							...
							<div class="down-content">
								<a href="<?= base_url('Cosmic_Game_Shop/dataDetails_Parent_AccessoriesParent_Accessories_PS2') ?>">
									<h4><span>PS 2</span></h4>
								</a>
									...
									<div class="row">
										<div class="col-lg-12">
											<ul class="post-tags">
												...
												<li><a href="<?= base_url('Cosmic_Game_Shop/dataDetails_Parent_AccessoriesParent_Accessories_PS2') ?>">View Products</a></li>
											</ul>
										</div>
									</div>
								</div>
					...
					<div class="col-md-4 col-sm-6">
						<div class="blog-post">
							...
							<div class="down-content">
								<a href="<?= base_url('Cosmic_Game_Shop/dataDetails_Parent_AccessoriesParent_Accessories_PS3') ?>">
									<h4><span>PS 3</span></h4>
								</a>
								<div class="post-options">
									<div class="row">
										<div class="col-lg-12">
											<ul class="post-tags">
												<li><i class="fa fa-bullseye"></i></li>
												<li><a href="<?= base_url('Cosmic_Game_Shop/dataDetails_Parent_AccessoriesParent_Accessories_PS3') ?>">View Product</a></li>
											</ul>
										</div>
									</div>
								</div>
					...
					<div class="col-md-4 col-sm-6">
						<div class="blog-post">
							...
							<div class="down-content">
								<a href="<?= base_url('Cosmic_Game_Shop/dataDetails_Parent_AccessoriesParent_Accessories_PS4') ?>">
									<h4><span>PS 4</span></h4>
								</a>
								<div class="post-options">
									<div class="row">
										<div class="col-lg-12">
											<ul class="post-tags">
												<li><i class="fa fa-bullseye"></i></li>
												<li><a href="<?= base_url('Cosmic_Game_Shop/dataDetails_Parent_AccessoriesParent_Accessories_PS4') ?>">View Product</a></li>
											</ul>
										</div>
									</div>
								</div>
					...
					<div class="col-md-4 col-sm-6">
						<div class="blog-post">
							...
							<div class="down-content">
								<a href="<?= base_url('Cosmic_Game_Shop/dataDetails_Parent_AccessoriesParent_Accessories_PS5') ?>">
									<h4><span>PS 5</span></h4>
								</a>
								<div class="post-options">
									<div class="row">
										<div class="col-lg-12">
											<ul class="post-tags">
												<li><i class="fa fa-bullseye"></i></li>
												<li><a href="<?= base_url('Cosmic_Game_Shop/dataDetails_Parent_AccessoriesParent_Accessories_PS5') ?>">View Product</a></li>
											</ul>
										</div>
									</div>
								</div>
