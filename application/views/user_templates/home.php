						...
						<div class="row">
							...
							<div class="col-lg-4">
								<div class="main-button">
									<a href="<?= base_url('Cosmic_Game_Shop/location') ?>">Contact Us</a>
								</div>
							</div>
						</div>
					</div>
					...
					<ul>
						<li>
							<div class="right-content">
								<p>Cosmic Game Shop sudah berdiri dari tahun 2000, selama lebih dari 2 dekade Cosmic Game Shop berkecimpung di dunia game.</p>
							</div>
							<br>
							<div class="right-content">
								<p>Cosmic Game Shop menjual berbagai jenis game console seperti Sony PlayStation, Nintendo, Microsoft XBOX, dan aksesoris lainnya.</p>
							</div>
					</ul>
				</div>
