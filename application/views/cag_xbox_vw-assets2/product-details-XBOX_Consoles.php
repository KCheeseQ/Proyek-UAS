...
<body>
	...
	<!-- Add your Create Consoles For XBOX button here -->
	<a href="<?= base_url('Cosmic_Game_Shop/dataDetails_Parent_Consoles') ?>"></a>
						...
						<div class="col-md-4 col-sm-6">
							<div class="blog-post">
								<div class="blog-thumb">
									<img src="<?= base_url('assets/img/consoles_xbox/') . $us['image']; ?>">
								</div>
