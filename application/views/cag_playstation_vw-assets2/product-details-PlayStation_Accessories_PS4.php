...
<body>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="text-content">
							<h2>PlayStation 4 Accessories</h2>
						</div>
					</div>
				</div>
			</div>
	...
	<!-- Banner Ends Here -->
	<a href="<?= base_url('Cosmic_Game_Shop/dataDetails_Parent_AccessoriesParent_Accessories_PS4') ?>"></a>
						...
						<div class="col-md-4 col-sm-6">
							<div class="blog-post">
								<div class="blog-thumb">
									<img src="<?= base_url('assets/img/accessories_ps4/') . $us['image']; ?>">
								</div>
